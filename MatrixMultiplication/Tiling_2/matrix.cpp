...
struct OpenCL_Ctrl
{
    ...
    OpenCL_Ctrl() : platform_id(0), device_id(0), timing(false), dataType(TYPE_INT), dataSizeW(1024), dataSizeH(1024), dataSizeM(1024), verify(false), localSize(1) {sprintf(powerFile, "KernelExecution.log");}
