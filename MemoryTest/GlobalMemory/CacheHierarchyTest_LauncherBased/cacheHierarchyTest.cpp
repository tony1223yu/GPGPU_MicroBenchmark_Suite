...
int main(int argc, char *argv[])
{
    ...
    size_t globalSize[1], localSize[1], dispatchSize;
    ...
    error = clGetKernelWorkGroupInfo(kernel1, device, CL_KERNEL_PREFERRED_WORK_GROUP_SIZE_MULTIPLE, sizeof(size_t), &dispatchSize, NULL);
    CHECK_CL_ERROR(error);
    fprintf(stderr, "Dispatch size = %lu\n", dispatchSize);
